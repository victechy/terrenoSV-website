...
export const dictionary = {
  en: {
    ...
    agent: {
      ...
      contactMessage: "Hi! I found your page on terrenoSV and I'm interested in your listings.",
  ...
  es: {
    ...
    agent: {
      ...
      contactMessage: "¡Hola! Encontré tu página en terrenoSV y me interesan tus publicaciones.",
